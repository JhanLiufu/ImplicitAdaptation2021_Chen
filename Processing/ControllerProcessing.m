...
figure;
plot(targetdata(1:90), finaldata(1:90), "rx");
hold on;
plot(targetdata(91:210), finaldata(91:210), "go");
plot([-10,20], [-10,20], "k-");
plot(targetdata(91:95), finaldata(91:95), "b.-");
plot(targetdata(91), finaldata(91), "bo");
plot([-10,20], [10,-20], "k--");
