...
for i=1:Ntrials
    ...
    onlinecursor(i) = priopout(i) - 30; % CCW rotation 45
    ...
    % Cursor-to-target error
    absoluteerror(i) = abs(onlinecursor(i) - vision(i));
    signederror(i) = onlinecursor(i) - vision(i);
    % Hand-to-target error
...
saveas(gcf,'RotationModelSensoryMapChange_LauFoo_20220128_1.png');
cd(root_dir);
...
title('Reach Direction By Block');
...
saveas(gcf,'RotationModelReacByBlock_LauFoo_20220128_1.png');
cd(root_dir);
...
saveas(gcf,'RotationModelHandVersusTarget_LauFoo_20220128_1.png');
cd(root_dir);
...
saveas(gcf,'RotationModelSignedError_LauFoo_20220128_1.png');
cd(root_dir);
...
saveas(gcf,'RotationlModelAbsoluteError_LauFoo_20220128_1.png');
cd(root_dir);
...
title('Reach Direction versus Target Direction');
...
saveas(gcf,'RotationlModelReachByTarget_LauFoo_20220128_1.png');
cd(root_dir);
...
saveas(gcf,'RotationModelSlopeOffset_LauFoo_20220128_1.png');
cd(root_dir);
